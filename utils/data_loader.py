...
class RSDataset(Dataset):
    ...
    def __init__(self, data_root, data_name='CVOGL', split_name='train', img_size=1024,
        ...
        self.query_transform = albumentations.Compose([
            ...
            albumentations.HueSaturationValue(p=0.20),
            albumentations.RandomBrightnessContrast(p=0.20),
            albumentations.ToGray(p=0.05),
        ])
    ...
    def __getitem__(self, idx):
        ...
        if self.augment:
            queryimg = self.query_transform(image=queryimg)['image']
